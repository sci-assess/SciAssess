...
class O1Azure(CompletionFn):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if openai_create_prompt[0]['role'] == 'system':
            openai_create_prompt[1]['content'] = openai_create_prompt[0]['content'] + '\n' + openai_create_prompt[1]['content']
            openai_create_prompt = openai_create_prompt[1:]
